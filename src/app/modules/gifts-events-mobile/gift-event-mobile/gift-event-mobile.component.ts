...
@Component({
  selector: 'app-gift-event-mobile',
  templateUrl: './gift-event-mobile.component.html',
  styleUrls: ['./gift-event-mobile.component.scss']
})
export class GiftEventMobileComponent implements OnInit {
