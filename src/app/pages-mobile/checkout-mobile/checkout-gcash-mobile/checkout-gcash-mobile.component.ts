...
@Component({
  selector: 'app-checkout-gcash-mobile',
  templateUrl: './checkout-gcash-mobile.component.html',
  styleUrls: ['./checkout-gcash-mobile.component.scss']
})
export class CheckoutGcashMobileComponent implements OnInit {
