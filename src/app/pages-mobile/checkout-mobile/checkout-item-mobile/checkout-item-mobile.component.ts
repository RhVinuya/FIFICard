...
@Component({
  selector: 'app-checkout-item-mobile',
  templateUrl: './checkout-item-mobile.component.html',
  styleUrls: ['./checkout-item-mobile.component.scss']
})
export class CheckoutItemMobileComponent implements OnInit {
