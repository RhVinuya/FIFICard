...
@Component({
  selector: 'app-payment-card-mobile',
  templateUrl: './payment-card-mobile.component.html',
  styleUrls: ['./payment-card-mobile.component.scss']
})
export class PaymentCardMobileComponent implements OnInit {
